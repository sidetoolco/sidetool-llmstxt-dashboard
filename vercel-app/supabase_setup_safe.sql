-- Safe Supabase Setup for LLMs.txt Generator
-- This version handles existing tables and potential conflicts

-- Enable UUID extension
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Drop existing policies and tables if they exist (clean slate)
DROP POLICY IF EXISTS "Users can view own profile" ON users;
DROP POLICY IF EXISTS "Users can update own profile" ON users;
DROP POLICY IF EXISTS "Users can insert own profile" ON users;
DROP POLICY IF EXISTS "Users can view own jobs" ON crawl_jobs;
DROP POLICY IF EXISTS "Users can create own jobs" ON crawl_jobs;
DROP POLICY IF EXISTS "Users can update own jobs" ON crawl_jobs;
DROP POLICY IF EXISTS "Users can delete own jobs" ON crawl_jobs;
DROP POLICY IF EXISTS "Users can view urls from own jobs" ON crawled_urls;
DROP POLICY IF EXISTS "Service role can insert urls" ON crawled_urls;
DROP POLICY IF EXISTS "Service role can update urls" ON crawled_urls;
...
DROP TABLE IF EXISTS crawled_urls CASCADE;
